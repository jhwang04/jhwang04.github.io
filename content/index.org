...
\\
* About Me
I am a fourth-year Computer Engineering major with concentrations in Computing Hardware and System Architecture. I chose this
...
and attend meetings for RUF (a campus ministry).
...
I also plan on learning as much as I can while interning at Tesla and SpaceX and applying those
...
** Solving Jane Street's ASIC Challenge /(Summer 2026)/
In August 2026, Jane Street posted a challenge on their [[https://blog.janestreet.com/can-you-reverse-engineer-an-asic/][blog]] about reverse-engineering
an ASIC. I spent ~30 hours over the course of the month trying to solve this puzzle.
Here's a write-up of how I did it! /[[./asic-challenge/asic-challenge.html][(read more)]]/
...
** Compilers, Interpreters, and Program Analyzers (Spring 2026)
From the [[https://catalog.gatech.edu/courses-undergrad/cs][course catalog]] (CS 4240):
#+begin_quote

Study of techniques for the design and implementation of compilers, interpreters, and program
analyzers, with consideration of the particular characteristics of widely used programming languages.
#+end_quote

** Advanced Computer Architecture (Spring 2026)
From the [[https://catalog.gatech.edu/courses-undergrad/ece][course catalog]] (ECE 4100):
#+begin_quote

Comprehensive coverage of the architecture and system issues that confront the design of
high-performance workstation/PC computer architectures with emphasis on quantitative evaluation.
#+end_quote

** Design of Operating Systems (Spring 2026)
From the [[https://catalog.gatech.edu/courses-undergrad/cs][course catalog]] (CS 3210):
#+begin_quote

Operating systems concepts, including multi-threading, scheduling, synchronization, communication,
and access control. Projects will cover design and implementation of several operating systems
components.
#+end_quote

** VLSI and Advanced Digital Design (Fall 2025)
From the [[https://catalog.gatech.edu/courses-undergrad/ece][course catalog]] (ECE 3150):
#+begin_quote

Advanced digital design issues in the context of VLSI systems. Introduction to a design
methodology that encompasses the range from architectural models to circuit simulation.
#+end_quote

** Physical Foundations of Computer Engineering (Fall 2025)
From the [[https://catalog.gatech.edu/courses-undergrad/ece][course catalog]] (ECE 3030):
#+begin_quote

Basic principles governing the physical realization of computing systems and their relationship
to characteristics such as performance, energy, and robustness. Implementation technologies.
#+end_quote

** Design and Analysis of Algorithms (Fall 2025)
From the [[https://catalog.gatech.edu/courses-undergrad/cs][course catalog]] (CS 3510):
#+begin_quote

Basic techniques of design and analysis of efficient algorithms for standard computational
