...
\\
* Career Goals
Five years from now, I hope to graduate with a Master's degree in Electrical and Computer
...
would also develop practical skills, but in a more profesional environment.
...
tester files to monopolize the market. /(read more)/

\\
\\

** LaTeX note-taking system using Emacs
...
and elegantly during class. /(read more)/
